...
<body class="login-page">
    <div class="login-box">
        <div class="logo">
            <a href="javascript:void(0);">Flow<b>Mail</b></a>
            <small>Email Marketing System</small>
        </div>
        <div class="card">
            <div class="body">
                <form id="sign_in" method="POST" action="{{URL('/authentication')}}" enctype="multipart/form-data">
